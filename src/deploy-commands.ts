    ...
    try {
        await (async () => {
            try {
                ...
                // Retrieve the list of existing commands.
                let commands = await rest.get(Routes.applicationCommands(process.env.CLIENT_ID));
                ...
                console.log('Successfully purged all commands.');
            } catch (error) {
                console.error(error);
            }
        })();
